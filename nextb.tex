...
This simple Monte Carlo allows us to study the influence of multiple scattering present in the simulated events in a
...
Note that other factors also affect the ability to reject background based ont he asymmetry factor.  In this
...
simple model, in practice will not be perfect and will also serve to weaken the background rejection power.  These factors are taken into account in the results of the more detailed Monte Carlo study presented in section \ref{sec:results}.
